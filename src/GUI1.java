...
public class GUI1 {
	...
	private void initialize() {
		...
		frmAdministradorDeAspirantes.setBounds(200, 200, 600, 500);
		...
		btnIngresar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				txtDpi.setText("DPI");
				SMate.setValue(0);
				SHistoria.setValue(0);
				SLenguaje.setValue(0);
				Sanio1.setValue(0);
				Sanio2.setValue(0);
				Sanio3.setValue(0);
				SAptitud.setValue(0);
		...
		sl_panel.putConstraint(SpringLayout.WEST, txtDpi, 0, SpringLayout.WEST, SAptitud);
		...
		Supera80.setFont(new Font("Tahoma", Font.PLAIN, 10));
		...
		sl_panel.putConstraint(SpringLayout.NORTH, btnActualizar, -1, SpringLayout.NORTH, SMate);
		...
		btnActualizar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Supera80.setText(xd.verFifty());
			}
		});
		panel.add(btnActualizar);
		
		btnVerificar = new JButton("Verificar");
		sl_panel.putConstraint(SpringLayout.WEST, btnVerificar, 305, SpringLayout.WEST, panel);
		sl_panel.putConstraint(SpringLayout.EAST, btnIngresar, -36, SpringLayout.WEST, btnVerificar);
		sl_panel.putConstraint(SpringLayout.NORTH, btnVerificar, 0, SpringLayout.NORTH, btnIngresar);
		btnVerificar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				txtSino.setText(xd.verifica((float)SSuperar.getValue()));
			}
		});
		panel.add(btnVerificar);
		
		txtSino = new JTextField();
		sl_panel.putConstraint(SpringLayout.WEST, btnActualizar, 0, SpringLayout.WEST, txtSino);
		sl_panel.putConstraint(SpringLayout.EAST, btnVerificar, -27, SpringLayout.WEST, txtSino);
		sl_panel.putConstraint(SpringLayout.NORTH, txtSino, 1, SpringLayout.NORTH, btnIngresar);
		...
		JLabel lblPromedioASuperar = new JLabel("\u00BFLos aspirantes desvinculados de  ");
		sl_panel.putConstraint(SpringLayout.NORTH, lblPromedioASuperar, 0, SpringLayout.NORTH, lblExamenDeAptitudes);
		sl_panel.putConstraint(SpringLayout.WEST, lblPromedioASuperar, 6, SpringLayout.EAST, verticalStrut);
		lblPromedioASuperar.setHorizontalAlignment(SwingConstants.LEFT);
		panel.add(lblPromedioASuperar);
		
		SSuperar = new JSpinner();
		sl_panel.putConstraint(SpringLayout.SOUTH, SSuperar, -6, SpringLayout.NORTH, txtSino);
		...
		JLabel lblSecundariaSuperanEste = new JLabel("secundaria superan este promedio? --->");
		sl_panel.putConstraint(SpringLayout.SOUTH, lblSecundariaSuperanEste, -6, SpringLayout.NORTH, btnVerificar);
		sl_panel.putConstraint(SpringLayout.EAST, lblSecundariaSuperanEste, -23, SpringLayout.WEST, SSuperar);
		panel.add(lblSecundariaSuperanEste);
	}
